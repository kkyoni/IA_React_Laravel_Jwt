...
<body style="padding:0px; margin:0px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif">
        ...
        <tr>
            <td>
                <div
                    style="margin:0 auto; text-align:left; font-size:15px; color:#181715; margin-top:40px; line-height:22px; max-width:600px; min-width:340px; width:100%;">
                </div>
